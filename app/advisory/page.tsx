...
export const metadata: Metadata = {
  ...
  description:
    "Portfolio-level clarity for investors with significant DSCR exposure. Invite-only advisory for those who need structured thinking around exposure, leverage, and downside.",
  keywords: [
    "DSCR advisory",
    "investor advisory",
  ...
  openGraph: {
    ...
    description:
      "For investors who need portfolio-level clarity—not transactional advice. Invite-only engagement.",
...
const jsonLd = {
  ...
  description:
    "Portfolio-level advisory for investors using residential DSCR loans who want to understand how financing decisions affect risk across an entire portfolio.",
  provider: {
    "@type": "Person",
        ...
        <section className="pt-28 sm:pt-36 lg:pt-44 pb-8 sm:pb-12 bg-background">
          <div className="max-w-4xl mx-auto px-6 sm:px-8 lg:px-10">
            ...
            <p className="text-xl text-muted-foreground">
              For investors who need portfolio-level clarity—not transactional
              advice.
            </p>
          </div>
        </section>
        ...
        <section className="py-16 sm:py-20 lg:py-24 border-t border-border">
          <div className="max-w-4xl mx-auto px-6 sm:px-8 lg:px-10">
            <div className="space-y-4 text-lg text-muted-foreground leading-relaxed">
              <p>
                Advisory is designed for investors using residential DSCR loans
                who want to understand how financing decisions affect risk
                across an entire portfolio.
              </p>
              <p>This is not rate shopping.</p>
              <p>This is not deal-by-deal approval help.</p>
              <p className="text-foreground font-medium">
                It is structured thinking around exposure, leverage, and
                downside.
              </p>
            </div>
          </div>
          ...
          <div className="max-w-4xl mx-auto px-6 sm:px-8 lg:px-10">
            ...
            <div className="space-y-8 mb-10">
              <div className="flex gap-6">
                <span className="text-3xl font-bold text-muted-foreground flex-shrink-0 w-8">
                  1.
                </span>
              ...
              <div className="flex gap-6">
                ...
                <p className="text-lg text-foreground">
                  Next steps are determined if there's alignment
                </p>
              </div>
            </div>
            {/* Book CTA Buttons */}
